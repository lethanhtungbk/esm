    ...
    public function run() {
        ...
        DB::table('field_types')->insert(
                array(
                    ...
                    array('id' => 3, 'name' => 'Image', 'groupId' => 1, 'group' => 'Single Value', 'display' => 'image'),
                    array('id' => 4, 'name' => 'Audio', 'groupId' => 1, 'group' => 'Single Value', 'display' => 'audio'),
                    array('id' => 5, 'name' => 'Video', 'groupId' => 1, 'group' => 'Single Value', 'display' => 'video'),
                    array('id' => 6, 'name' => 'File Attachment', 'groupId' => 1, 'group' => 'Single Value', 'display' => 'attachment'),
